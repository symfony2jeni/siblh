$(document).ready(function() {
  ...
  /* $('#reporte').click(function(){
   ...
   $( "#exportar_pdfl" ).button();  
      
    $('#exportar_pdfl').click(function() {
     ...
     $ff= $('#fechaf').val();          
      ...
      if (($fi == " ") || ($ff == " ") || ($ff < $fi))
          ...
          url = Routing.generate('_exportar_reporte_ldescartada') + '/LecheDescartada/pdf?fechai=' + $('#fechai').val() + '&fechaf=' + $('#fechaf').val()+ '&id=' + $('#id').val()+ '&nombre=' + $('#nombre').val();
