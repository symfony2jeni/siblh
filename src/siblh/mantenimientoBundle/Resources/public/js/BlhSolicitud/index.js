$(document).ready(function() {
    ...
    tableToGrid("#listado_solicitudes", {
        ...
        colModel :[
            {name:'Código&nbsp;Solicitud',width:25,align:'center'},
            {name:'Fecha', width:15,align:'center'},
            {name:'Peso&nbsp;del&nbsp;paciente(g)', width:30,align:'center'},
            {name:'Volumen&nbsp;por&nbsp;toma(ml)', width:28,align:'center'}, 
            {name:'Tomas&nbsp;por&nbsp;día', width:20,align:'center'},
            {name:'Calorías&nbsp;necesarias', width:25,align:'center'},
            {name:'Acidez&nbsp;Dornic', width:20,align:'center'},
            {name:'Volumen&nbsp;total&nbsp;por&nbsp;día(ml)', width:30,align:'center'},
